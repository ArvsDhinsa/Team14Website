                    ...
                    <div class="card-text p-3">
                        <form>
                            <div class="form-group">
                                ...
                                <input type="username" class="form-control form-control-sm" id="inputUsername"/>
                            </div>
                            <div class="form-group">
                            ...
                            <button type="submit" class="btn btn-primary btn-lg btn-block my-3">Signup</button>
                            <div class="signup">Already a member? <a href="login.php">Login Here</a></div>
                        </form>
                    </div>
                </div>
            </div>
